...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.1e4373fb93cd6c49fe5f84b3cf07beb15a5b8da2604d30501065b4901d3992d7.js',function(){input.required=false;search();});}
