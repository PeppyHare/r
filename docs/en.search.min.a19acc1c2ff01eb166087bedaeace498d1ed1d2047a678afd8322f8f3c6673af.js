...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.f206f1030a79b3aec90bf2500bdaf7c0fd73d5617f178319fb950bffdeb1827c.js',function(){input.required=false;search();});}
