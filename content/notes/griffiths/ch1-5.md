...
{{< katex display >}} \int_0 ^3 x^3 \delta(x-2) \dd x 
{{< katex display >}}"
...
!!! question "Show that {{< /katex >}}
 \delta(kx) = \frac{1}{|k||}\delta(x) {{< /katex >}}
...
!!! question "Evaluate the integral 
{{< katex display >}} J = \int_V (r^2 + 2) \div \left( \frac{\vu{r}}{r^2} \right) \dd \tau 
{{< katex display >}} where \\( V \\) is a sphere of radius R centered at the origin."
