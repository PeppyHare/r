...
<p align="center"> <img alt="Figure 20.2" src="/r/img/20.2.png" width=500px/> </p>
...
This method is applicable for non-lifting bodies. Without circulation (vortices) there can't be any lift. We can modify the model by including a term that corresponds with circulation, we can allow for lift.
...
{{< katex display >}}
\phi _p = \frac{1}{2 \pi} \int \gamma \theta \dd s = \frac{1}{2 \pi} \int \tan ^{-1} \left( \frac{y_p - y}{x_p - x} \right) \gamma \dd s
{{< /katex >}}

<p align="center"> <img alt="Figure 20.3" src="/r/img/20.3.png" width=200px/> </p>
