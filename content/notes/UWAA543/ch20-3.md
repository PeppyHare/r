...
{{< katex display >}}
\rightarrow \rho_x = - \frac{\rho}{2 a^2} (\phi_x ^2 + \phi_y ^2) _x = - \frac{\rho}{a^2} ( \phi_x \phi_{xx} + \phi_y \phi_{xy})
{{< /katex >}}
...
We assume that \\( u', v' \ll u_\infty \\), which is the basis of our perturbation theory.
...
\\( a_{\infty} \\) is the speed of sound in the bulk flow
