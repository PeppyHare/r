...
{{< katex display >}}
\dv{\vec v_\alpha}{t} \equiv \pdv{\vec v_\alpha}{t} + (\vec v_\alpha \cdot \grad) \vec v_\alpha
{{< /katex >}}
...
{{< katex display >}}
\dv{f}{t} = A f \qquad f = f_0 + \epsilon f_1 + \epsilon ^2 f_2 + \epsilon^3 f_3 + \ldots
{{< /katex >}}
...
0 & 0 & \frac{\epsilon}{\epsilon_0} - n^2
\end{bmatrix}
{{< /katex >}}
