...
{{< katex display >}}
p_{e,f} - p_{e,i} = - m_e v - m_e v = - 2 m_e v = -2 p_{e,i}
{{< /katex >}}
...
{{< katex display >}}
\vec E \cross \vec B + (\vec v_\perp \cross \vec B) \cross \vec B = \eta_\perp \vec J \cross \vec B = \eta_\perp \grad p
{{< /katex >}}
{{< katex display >}}
