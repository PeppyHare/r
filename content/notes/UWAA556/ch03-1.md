...
\uparrow & \qquad h_{\alpha \beta \gamma} \sim O(\Lambda ^{-2})
\end{aligned}
{{< /katex >}}
...
This assumption is valid either when density is very high, or \\( \lambda_D = \sqrt{\frac{\epsilon_0 T_e}{e^2 n_e}} \\) has to very large, which happens at very high temperatures. Physically, if kinetic energy of interactions dominates the potential energy change, then the plasma behaves like a perfect gas.
