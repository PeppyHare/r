...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.24b50713604cd7ee4d9dadfb9237034f0e0808674291e6164de64fb0969514c2.js',function(){input.required=false;search();});}
