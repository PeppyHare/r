...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.483139caccd7d667768bfb4bf87fdf0e107def081ccb6162aa690db3afe7c2ba.js',function(){input.required=false;search();});}
