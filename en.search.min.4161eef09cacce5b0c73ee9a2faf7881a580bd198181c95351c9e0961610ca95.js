...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.aa3a355371c516fff7b558f9b5026a91c4fca01f82f70aaceeebeadfd24d99d0.js',function(){input.required=false;search();});}
