...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.f01b4ed4e09e2e2800c78c1d7cccb99d11899276cf30aacda36437359e02858e.js',function(){input.required=false;search();});}
