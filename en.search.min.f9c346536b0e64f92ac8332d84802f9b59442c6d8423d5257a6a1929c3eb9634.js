...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/r/flexsearch.min.js');loadScript('/r/en.search-data.min.632ccb1036783db1d5b82e06a2c6570af39f7ad69b2a21b2697d46ee5b46bce5.js',function(){input.required=false;search();});}
